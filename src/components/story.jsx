function Story() {
  return (
    ...
    >
      <div className="story text-center max-w-4xl">
        <h1 className="text-4xl font-bold mb-6 text-gray-900">
          OUR LOVE STORY
        </h1>
        <div className="mt-4 bg-white p-6 rounded-lg shadow-lg">
          <h2 className="text-2xl font-semibold mb-4 text-gray-700 text-purple-950 ">BRIDE</h2>
          <p className="text-lg leading-relaxed text-gray-600">
            ...
            <br />
            From that one picture, one message, one call, a beautiful love story
            unfolded. We’ve been together for two amazing years now, coupled
            with the fact that it was a distance relationship, and what started
            with a WhatsApp status is blossoming into a lifetime commitment.
            <br />
            It’s funny how love works. Sometimes, it waits for the right time to
            show up, even if it means circling back to someone who was once just
          ...
          <div className="mt-4 bg-white p-6 rounded-lg shadow-lg">
          <h2 className="text-2xl font-semibold mb-4 text-purple-950">GROOM</h2>
          <p className="text-lg leading-relaxed text-gray-600">
            Abass and I went to the same secondary school, but that's not where
            it all started from. We barely knew each other then because I
            transferred to a different school.
